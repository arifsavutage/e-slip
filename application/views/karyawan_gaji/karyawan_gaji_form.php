                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            ?>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="tunjangan_value[]" id="tunjangan_value" value="0" required="required" />
                                        <input type="hidden" name="tunjangan_id[]" value="<?= $var->id ?>" />
                                    </div>
                            <?php
                                endif;
                            endforeach;
                        ...
                        <div class="col-md-6">
                            ...
                            ?>
                                    <div class="form-group">
                                        <label for="int"><?= $var->nama_variabel ?></label>
                                        <input type="text" class="form-control" name="pot_value[]" value="0" required="required" />
                                        <input type="hidden" name="pot_id[]" value="<?= $var->id ?>" />
                                    </div>
                            <?php
                                endif;
                            endforeach;
